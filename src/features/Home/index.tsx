  ...
  return (
    <div className="pt-10">
      <div className="flex items-center justify-center">
        ...
        <h1 className="text-2xl font-bold ml-4">News</h1>
      </div>
      <div className="mb-20 mt-5 w-full flex justify-center">
        <Input
          placeholder="Search..."
          className="my-5 max-w-[700px] bg-white ring-offset-0 ring-0 placeholder:text-sm"
        />
      </div>
      <h2 className="text-xl font-semibold pl-3 mb-4">Latest News</h2>
